...
void MenuWindow::serverActive()
{
    ...
    player_guide->setGeometry(oi->pname_guide->getRect());
    ...
    player_name->setGeometry(oi->pname->getRect());
    ...
    ip_guide->setGeometry(oi->ip_guide->getRect());
    ...
    ip_show->setGeometry(oi->ip->getRect());
    ...
    start_guide->setGeometry(oi->start_guide->getRect());
    ...
    start_btn->setGeometry(oi->start->getRect());
...
void MenuWindow::clientActive()
{
    ...
    ip_input->setGeometry(oi->ip->getRect());
